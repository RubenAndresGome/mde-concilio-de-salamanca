...
from concilio_salamanca.prompts.system_prompts import PONYTAIL
from concilio_salamanca.schemas import AgentOutput


class Ponytail(AgenteBase):
    role_name = "Magister Minimalis (Ponytail/YAGNI)"
    system_prompt = PONYTAIL
