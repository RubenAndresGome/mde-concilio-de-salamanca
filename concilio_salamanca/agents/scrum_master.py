...
from concilio_salamanca.prompts.system_prompts import SCRUM_MASTER
from concilio_salamanca.schemas import AgentOutput


class ScrumMaster(AgenteBase):
    role_name = "Magister Processus (Scrum Master)"
    system_prompt = SCRUM_MASTER
