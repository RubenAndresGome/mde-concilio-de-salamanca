...
from concilio_salamanca.prompts.system_prompts import DEFENSOR_LEON_XIII
from concilio_salamanca.schemas import AgentOutput


class DefensorLeonXIII(AgenteBase):
    role_name = "Defensor Leonis XIII"
    system_prompt = DEFENSOR_LEON_XIII
