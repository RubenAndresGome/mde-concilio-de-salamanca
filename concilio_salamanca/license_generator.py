...
class LicenseGenerator:
    ...
    def generate_license(self, country_code: str = "US") -> str:
        ...
        return f"""# RERUM NOVARUM STATUTO (RNS) v4.1{std_tag}
...
**4.1 Base de Calculo: Margen Bruto Operativo**
...
**4.1 Bis — Tabla Plana Corporativa (Alternativa Simplificada)**
...
**4.2 Metricas por Tipo de Negocio**
...
**4.3 Pago en codigo o en licencia**
...
**4.5 Modelo Deuda para Startups (0% Interes Real)**
...
[![License: Rerum Novarum Statuto 4.1](https://img.shields.io/badge/License-Rerum_Novarum_4.1-purple.svg)](LICENSE.md)
